...
export class Sdk extends HeyApiClient {
     ...
     */
    public listTeamOccurrences<ThrowOnError extends boolean = false>(options: Options<ListTeamOccurrencesData, ThrowOnError>): RequestResult<ListTeamOccurrencesResponses, ListTeamOccurrencesErrors, ThrowOnError> {
        return (options.client ?? this.client).get<ListTeamOccurrencesResponses, ListTeamOccurrencesErrors, ThrowOnError>({ url: '/calendar-events/team', ...options });
    }
